...
public class NewsMeAdapter extends BaseItemDraggableAdapter<News, BaseViewHolder> {

    public NewsMeAdapter(List<News> data) {
        super(data);
    }

    public NewsMeAdapter(int layoutResId, List<News> data) {
